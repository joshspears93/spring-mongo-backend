...
public class EmployeeControllerTest {
    ...
    public void setUp() throws Exception {
        ...
        when(employeeControllerMock.deleteEmployee("6789")).thenReturn(ResponseEntity.ok().build());
        when(employeeControllerMock.deleteEmployee("8899")).thenReturn(ResponseEntity.badRequest().build());
    ...
    public void deleteEmployeeTest() {
        ...
        assertEquals(returnedGoodResponse, ResponseEntity.ok().build());

        ResponseEntity<String> returnedBadResponse = employeeControllerMock.deleteEmployee("8899");
        assertNotNull(returnedBadResponse);
        assertEquals(returnedBadResponse, ResponseEntity.badRequest().build());
    }
